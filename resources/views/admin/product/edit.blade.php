...
<section class="content  style=" padding:20px"">
  <div class="container-fluid">
    ...
    <div id="accordion">
      <!-- form start -->
      <form action="{{route('admin.product.update', $product->id)}}" method="post" name="form-example-1" id="form-example-1" enctype="multipart/form-data">
        @csrf
        @METHOD('PUT')
        <!-- card common start -->
        <div class="card">
          ...
          <div id="collapseCommon" class="collapse show" aria-labelledby="common" data-parent="#accordion">
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control" value="{{$product->title}}" placeholder="Enter Title">
                <p class="small">{{config('app.url')}}<span id="url">{{$product->title}}</span></p>
                ...
                <div class="col-md">
                  <div class="form-group">
                    ...
                    <select name="brand_id" id="brand_id" data-placeholder="Select a Brand" class="select2 form-control" style="width: 100%;">
                      ...
                      <option value="{{$brand->id}}" {{$product->brand->id==$brand->id ? ' selected': ''}}> {{$brand->title}}</option>
                      @endforeach
                    </select>
                ...
                <div class="col-md">
                  <div class="form-input">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="price" value="{{$product->price}}" placeholder="00.00" class="form-control">
                ...
                <div class="col-md">
                  <div class="form-input">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="discount" value="{{$product->discount}}" placeholder="00.00" class="form-control">
                      <div class="input-group-append">
                        <span class="input-group-text">.00</span>
                      </div>
                    </div>
          ...
          <div id="collapseFeatured" class="collapse" aria-labelledby="Featured" data-parent="#accordion">
            <div class="card-body">
              <div class="custom-control custom-checkbox">
                <input class="custom-control-input" value="1" type="checkbox" id="featured" {{$product->featured ? ' checked': ''}}>
          ...
          <div id="collapseExtras" class="collapse" aria-labelledby="Extras" data-parent="#accordion">
            <div class="card-body" id="extras">
              ...
              <div class="row py-2" id="opt">
                ...
                <div class="col">
                  <input type='text' class="form-control" name="extras[Size]" value="{{$val}}">
                </div>
              </div>
              @endforeach
              @endif
...
<script>
  let requestURL = 'http://localhost/admin/categoriesJsonData';
  const CategoryIDS = '{{$IDStoString}}'
