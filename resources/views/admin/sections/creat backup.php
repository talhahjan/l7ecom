...
<section class="content" style="padding:20px;">
  <div class="container-fluid">
    ...
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form action="{{route('admin.section.store')}}" accept-charset="utf-8" enctype="multipart/form-data" method="post"> @csrf
        <div class="card-body">
          <div class="row">
            <div class="col-12">
              <!-- textarea -->
              <div class="form-group">
                <label>Title</label>
                <input type="text" id="title" name="title" class="form-control" value="" placeholder="Section Title">
          ...
          <div class="card-footer">
            ...
            <button type="submit" class="btn btn-outline-primary float-right"><i class="fa fa-plus-circle"></i> Create Section</button>
      </form>
    </div>
